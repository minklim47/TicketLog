    ...
    <div>
      ...
      <FormControl size="small" sx={sortStyle}>
        ...
        >
          ...
          <MenuItem value="ticket_date_new">by Ticket Date[Latest to oldest]</MenuItem>
          <MenuItem value="ticket_date_old">by Ticket Date[Oldest to latest]</MenuItem>

          <MenuItem value="created_at_new">by Created At[Latest to oldest]</MenuItem>
          <MenuItem value="created_at_old">by Created At[Oldest to latest]</MenuItem>
